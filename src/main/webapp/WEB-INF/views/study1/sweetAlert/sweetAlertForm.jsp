    ...
    */
    ...
    $(function() {
    	...
    	$("#confirm6").click(() => {
				Swal.fire({
					...
					//else Swal.fire("취소괴었습니다", "", "error");
						...
						Swal.fire("거부었습니다", "", "info");
					}
					else Swal.fire("취소었습니다", "", "error");
				});    		
    	});
    	...
    	$("#image1").click(() => {
    		swal.fire({
    			title: '그림연습1',
    			imageUrl: "https://cdn.pixabay.com/photo/2025/09/08/04/04/bearded-dragon-9821326_960_720.jpg",
    			imageAlt: '000000'
    		});
    	});
    		...
    		swal.fire({
    			title: 'html연습1',
					...
					html: `
							...
							<a href="http://www.daum.net" class="btn btn-success btn-sm" >다음</a> 방문하기
						`
    		});
    	});
...
<div class="container">
  ...
  <div class="mb-2">	
  	...
  	<button type="button" id="ex4" class="btn btn-danger">error1</button>
  ...
  <hr class="border-1 border-dark" />
  <div>
  	<button type="button" id="prompt1" class="btn btn-outline-secondary">prompt1</button>
  	...
  	<button type="button" id="image3" class="btn btn-outline-primary">image3</button>
